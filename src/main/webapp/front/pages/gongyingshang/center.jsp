						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="lianxifangshi" id="lianxifangshi" placeholder="联系方式" autocomplete="off" class="layui-input">
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<div class="layui-input-block">
								<img id="qiyefengmianImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" src="../../img/avator.png">
								<input type="hidden" id="qiyefengmian" name="qiyefengmian" />
							</div>
						</div>
						<div class="layui-form-item">
							<div class="layui-input-block">
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function() {
				...
				http.request(`${table}/session`, 'get', {}, function(data) {
					...
					form.val("myForm", data.data);
																																																																											// 图片赋值
					jquery("#qiyefengmianImg").attr("src", data.data.qiyefengmian);
														});
