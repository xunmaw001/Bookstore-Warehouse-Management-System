				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('tushuxinxi','进货')" @click="onAcrossTap('jinhuoxinxi')" type="button" class="layui-btn">
								进货
							</button>
																					<button v-if="isAuth('tushuxinxi','出货')" @click="onAcrossTap('chuhuoxinxi')" type="button" class="layui-btn">
								出货
							</button>
