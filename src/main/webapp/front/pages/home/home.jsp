...
<body>
  <div id="app">
    ...
    <div class="about-culture-box">
      <div class="about-culture">
        ...
        <div class="about-culture-piclist">
          <ul>
            <li v-for="(item,index) in tushuxinxiList" v-bind:key="index" @click="jump('../tushuxinxi/detail.jsp?id='+item.id)">
              <img :src="item.tupian?item.tupian.split(',')[0]:''" width="310" height="350" />
              <div class="about-culture-words">
                <h6>{{item.tushumingcheng}}</h6>
    ...
    <div class="about-culture-box">
      <div class="about-culture">
        ...
        <div class="about-culture-piclist">
          <ul>
            <li v-for="(item,index) in gongyingshangList" v-bind:key="index" @click="jump('../gongyingshang/detail.jsp?id='+item.id)">
              <img :src="item.qiyefengmian?item.qiyefengmian.split(',')[0]:''" width="310" height="350" />
              <div class="about-culture-words">
                <h6>{{item.gongyingshangmingcheng}}</h6>
                <p v-if="item.price">{{item.price}} RMB</p>
              </div>
            </li>
          </ul>
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`gongyingshang/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
