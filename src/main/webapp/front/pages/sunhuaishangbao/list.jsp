    ...
    <fieldset class="search-container" style="text-align: center;margin: 50px 0;">
      <form class="layui-form" style="margin: 10px 0;">
        ...
        <div class="layui-inline" style="margin-left: 30px;">
          ...
          <button v-if="isAuth('sunhuaishangbao','新增')" @click="jump('../sunhuaishangbao/add.jsp')" type="button" class="layui-btn btn-theme">
      ...
      <div class="box">
        <ul class="clearfix">
          <li v-for="(item,index) in dataList" v-bind:key="index">
            <a :href="'../sunhuaishangbao/detail.jsp?id='+item.id">
              <figure>
              </figure>
              <div class="div1">
                <b></b>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#tushubianhao').val()) {
          param['tushubianhao'] = jquery('#tushubianhao').val() ? '%' + jquery('#tushubianhao').val() + '%' : '';
        }  
        if (jquery('#tushumingcheng').val()) {
          param['tushumingcheng'] = jquery('#tushumingcheng').val() ? '%' + jquery('#tushumingcheng').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('sunhuaishangbao/list', 'get', param, function(res) {
