...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">损坏上报管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">损坏上报列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">损坏上报列表</h3>							
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
																																									<label>
												图书编号
												<input type="text" id="tushubianhaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
											</label>
																																																														<label>
												图书名称
												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('tushubianhao')">图书编号<i id="tushubianhaoIcon" class="fa fa-sort"></i></th>
																																																			...
																																																			<th onclick="sort('qingkuangshuoming')">情况说明<i id="qingkuangshuomingIcon" class="fa fa-sort"></i></th>
	...
	<script>
							...
							var tushubianhaoCell  = document.createElement('td');
									...
									row.appendChild(dengjishijianCell);
				            				var qingkuangshuomingCell  = document.createElement('td');
												  ...
												  //如果图文详情包含图片
				  if(item.qingkuangshuoming && item.qingkuangshuoming.indexOf('img') != -1){
					//暂时只考虑图片+文字 和 文字+图片的情况
					var beginIndex = item.qingkuangshuoming.indexOf('<img');
					var endIndex = item.qingkuangshuoming.indexOf('>');				
					qingkuangshuomingCell.innerHTML = item.qingkuangshuoming.substring(beginIndex, endIndex+1).replace("img","img width='100' height='100'");				
				  }else{
		...
		function sh(){
			...
			httpJson("sunhuaishangbao/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("sunhuaishangbao/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"sunhuaishangbao");
